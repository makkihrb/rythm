      ...
      <div className="grid gap-8 md:grid-cols-2">
        <div className="space-y-4">
          <div className="relative overflow-hidden rounded-lg bg-gray-100">
            <img src={product?.image} loading="lazy" alt="{product?.title}" className="h-full w-full object-cover object-center" />
        ...
        <div className="md:py-8">
          ...
          <span className="mb-0.5 inline-block text-gray-500">{product?.category?.toUpperCase()}</span>
          ...
          <div className="mb-6 flex items-center md:mb-10">
            ...
            <a href="#." className="ml-4 text-sm font-semibold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">View All 50 reviews</a>
          </div>
          ...
          <div className="mb-4">
            <div className="flex items-end gap-2">
              ...
              <span className="mb-0.5 text-red-500 line-through">$90.00</span>
            </div>
          ...
          <div className="flex gap-2.5">
            <button className="inline-block flex-1 rounded-lg bg-indigo-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 sm:flex-none md:text-base" onClick={() => handleCart(product)}>Add to cart</button>
            <button className="inline-block rounded-lg bg-gray-200 px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base" onClick={() => handleCart(product, true)}>Buy it now</button>


            <a href="/likes" className="inline-block rounded-lg bg-gray-200 px-4 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-300 focus-visible:ring active:text-gray-700 md:text-base">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
